...
export const enUS: Translations = {
  ...
  agents: {
    ...
    chat: "Chat",
    settings: "Settings",
    settingsTitle: (name: string) => `Configure ${name}`,
    ...
    fieldIcon: "Icon keyword",
    fieldDescription: "Description",
    fieldTags: "Tags (one per line)",
    fieldStarterPrompts: "Starter prompts (one per line)",
    fieldSoul: "SOUL.md",
    fieldModel: "Model",
    fieldToolGroups: "Tool group allowlist (one per line, blank inherits all)",
    ...
    skillsNone: "Disable all skills",
    skillsCustom: "Only selected skills",
    selectedSkillsCount: (count: number) =>
      `${count} selected skill${count === 1 ? "" : "s"}`,
    memoryReadGlobal: "Read global memory",
    memoryReadAgent: "Read agent memory",
    memoryDefaultWrite: "Default write target",
    memoryPreferenceWrite: "Stable preference write target",
    memoryScopeGlobal: "Global memory",
    memoryScopeAgent: "Agent memory",
    workspaceMode: "Workspace mode",
    workspaceThread: "Isolated workspace per thread",
    workspaceAgent: "Shared workspace for this agent",
    workspaceCustom: "Custom directory",
    workspacePath: "Workspace path",
    workspaceChoosePath: "Choose folder",
    workspaceIsolateThreads: "Isolate each thread under this workspace",
    workspaceAllowedPaths: "Allowed path notes (one per line)",
    delete: "Delete",
    deleteConfirm:
