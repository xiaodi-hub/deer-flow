...
export const zhCN: Translations = {
  ...
  agents: {
    ...
    chat: "对话",
    settings: "设置",
    settingsTitle: (name: string) => `配置 ${name}`,
    settingsProfile: "基础",
    settingsPrompt: "提示词",
    settingsTools: "模型与工具",
    settingsMemory: "记忆",
    settingsWorkspace: "工作区",
    settingsSaveSuccess: "智能体配置已保存",
    fieldName: "智能体目录名",
    ...
    fieldDescription: "描述",
    fieldTags: "标签（每行一个）",
    fieldStarterPrompts: "开场提示（每行一个）",
    fieldSoul: "SOUL.md",
    fieldModel: "模型",
    fieldToolGroups: "工具组白名单（每行一个，留空表示继承全部）",
    fieldMcpTools: "MCP 工具白名单（每行一个，留空表示继承全部）",
    fieldMcpServers: "MCP 服务器",
    fieldSkills: "技能",
    promptPolish: "优化提示词",
    promptPolishing: "正在优化...",
    promptPolishTooltip:
      "让智能体帮你把当前 SOUL.md 改写得更清晰、更适合长期使用",
    promptPolishSuccess: "提示词已优化",
    promptPolishNoChange: "提示词已经足够清晰，未做明显改动",
    promptRequiredError: "请先填写提示词",
    modelDefault: "使用系统默认模型",
    emptyMcpServers: "暂无 MCP 服务器",
    skillsAll: "使用全部已启用技能",
    skillsNone: "禁用全部技能",
    skillsCustom: "只允许选中的技能",
    selectedSkillsCount: (count: number) => `已选择 ${count} 个技能`,
    memoryReadGlobal: "读取全局记忆",
    memoryReadAgent: "读取场景记忆",
    memoryDefaultWrite: "默认写入位置",
    memoryPreferenceWrite: "稳定偏好写入位置",
    memoryScopeGlobal: "全局记忆",
    memoryScopeAgent: "场景记忆",
    workspaceMode: "工作区模式",
    workspaceThread: "每个会话独立工作区",
    workspaceAgent: "该智能体共享工作区",
    workspaceCustom: "自定义目录",
    workspacePath: "工作区目录",
    workspaceChoosePath: "选择目录",
    workspaceIsolateThreads: "按会话再隔离子目录",
    workspaceAllowedPaths: "允许目录备注（每行一个）",
    delete: "删除",
    ...
    createModeManual: "配置创建",
    createModeChat: "对话创建",
    createFromConfig: "生成智能体",
  ...
  settings: {
    ...
    appearance: {
      ...
      chatWidthTitle: "对话宽度",
      chatWidthDescription: "调整中间消息区和输入框的展示宽度。",
      chatWidthCompact: "紧凑",
      chatWidthDefault: "默认",
      chatWidthWide: "宽",
      chatWidthFull: "最大",
