...
export interface Translations {
  ...
  agents: {
    ...
    fieldTags: string;
    fieldStarterPrompts: string;
    fieldSoul: string;
    fieldModel: string;
    fieldToolGroups: string;
    ...
    memoryReadGlobal: string;
    memoryReadAgent: string;
    memoryDefaultWrite: string;
    memoryPreferenceWrite: string;
    memoryScopeGlobal: string;
    memoryScopeAgent: string;
    workspaceMode: string;
    workspaceThread: string;
    workspaceAgent: string;
    workspaceCustom: string;
    workspacePath: string;
    workspaceChoosePath: string;
    workspaceIsolateThreads: string;
