...
help:
	...
	@echo "  make config-upgrade  - Merge new fields from config.example/ into config/"
	...
	@echo "  make docker-start    - Start Docker services (mode-aware from config/runtime.yaml, localhost:2026)"
